...
ax1_2.set(xlabel="Zeit in s", ylabel="Spannung in V", title="Ausgangssignal w2")
...
axz21.set(xlabel="Zeit in s", ylabel="Spannung in V", title="Störsingal z21")
#plt.tight_layout()
# format x axis
# adding grid
...
filename ="Grafiken/V7_4_2_Eingaenge.svg"
...
filename ="Grafiken/V7_4_2_m.svg"
plt.savefig(filename, format="svg")
...
filename ="Grafiken/V7_4_2_Ausgaenge.svg"
plt.savefig(filename, format="svg")
plt.show()